...
В качестве языка написания стилей выбран [SCSS](https://sass-scss.ru).
...
### 2.1. Размещение переменных

#### 2.1.1. Переменные, определяющие z-index (порядок по оси Z)
...
#### 4.1.2. Модификаторы логического типа
