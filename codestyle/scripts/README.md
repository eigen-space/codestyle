...
* \[Не автоматизировано\] Закрывающая фигурная скобка должна быть на отдельной строке после тела управляющей 
  конструкции. 
...
#### 2.2.1. \[Не автоматизировано, но есть IDEA code format\] Величина отступа

Величина отступа должна составлять **4 пробела**. Не допускается использовать табуляцию.

#### 2.2.2. \[Не автоматизировано, но есть IDEA code format\] Блоки и блокоподобные конструкции
...
#### 2.2.4. \[Не автоматизировано, но есть IDEA code format\] Конструкция switch-case
...
#### 2.3.1. \[Не автоматизировано\] В одной строке должно быть не более одного выражения
...
#### 2.4.2. \[Не автоматизировано, но есть IDEA code format\] Отступ при переносе части выражения
...
#### 2.4.6. \[Не автоматизировано\] Перенос массивов
...
#### 2.4.10. \[Не автоматизировано\] Перенос запятой при переносе выражений
...
### 2.6. \[Не автоматизировано\] Использование скобок для группировки
...
#### 2.7.3. \[Не автоматизировано\] Не использовать комментарии в конце строки
...
#### 2.8.2. \[Не автоматизировано\] Группировка аксессоров (get/set)
...
#### 3.1.2. \[Не автоматизировано, но есть IDEA code format\] Объявлять по одной переменной за один раз
...
#### 3.5.1. \[Не автоматизировано\] Конструктор

a. \[Не автоматизировано. Не работает no-useless-constructor\] Не нужно объявлять конструктор, если он не используется.
...
#### 3.6.9. \[Не автоматизировано\] Возвращаемое значение
...
#### 3.11.1. \[Не автоматизировано\] Использование функций-обёрток
...
#### 3.11.4. \[Не автоматизировано\] Указывать систему счисления при использовании `parseInt`
...
### 3.13. \[Автоматизировано: no-magic-numbers\] Магические строки и числа
