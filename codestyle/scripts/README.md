...
c. \[Не автоматизировано\] При использовании знака равенства при сравнении переменной и литерала (или константы) 
...
g. \[Не автоматизировано\] По возможности избегать лишних ветвей `else`. Это уместно, когда одно из значений 
