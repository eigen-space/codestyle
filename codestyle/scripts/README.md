...
### 1.1. Правила именования \[Не автоматизировано\]
...
### 1.3. JSDoc в начале файла \[Не автоматизировано\]
...
#### 2.1.1. Скобки для управляющих конструкций \[Автоматизировано: curly\]
...
* Открывающая фигурная скобка должна быть на той же строке, что и управляющая конструкция. \[Автоматизировано: one-line\]
* Перед открывающей скобкой должен быть пробел. \[Автоматизировано: one-line\]
* Закрывающая фигурная скобка должна быть на отдельной строке после тела управляющей 
  конструкции. \[Не автоматизировано\]
* Для составных управляющих конструкций следующая часть конструкции располагается 
  на той же строке, что и закрывающая скобка. \[Автоматизировано: one-line\]
...
#### 2.2.1. Величина отступа \[Не автоматизировано, но есть IDEA code format\]

Величина отступа должна составлять **4 пробела**. Не допускается использовать табуляцию.

#### 2.2.2. Блоки и блокоподобные конструкции \[Не автоматизировано, но есть IDEA code format\]
...
#### 2.2.3. Цепочки вызовов \[Автоматизировано: newline-per-chained-call\]
...
#### 2.2.4. Конструкция switch-case \[Не автоматизировано\]
