...
c. Инициализация объекта должна производиться в конструкторе, а не в отдельном методе, 
...
d. В конструкторе не нужно использовать `return`.

e. В конструкторе всегда принимать объект, даже если на вход мы ожидаем только одно поле 
