...
1. Changelog
2. review: merge request (pull request), количество и состав участников, выполняющих
обзор кода
3. microfix

#### 5.2.2. Выпуск следующей версии приложения
...
### 6.1. Отношение к оценке времени выполнения задачи
...
### 6.2. Отношение к сроку выполнения задачи

### 6.3. Анализ результатов итерации
