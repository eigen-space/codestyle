...
f. В начале процесса исправления замечаний задача переводится в соотвествующий рабочий статус. 
   После завершения исправлений задача переводится обратно в статус ревью.

g. После корректировки замечаний и реализации предложений должен запрашиваться
повторный обзор кода.

h. Все вопросы по ревью обсуждаются наибыстрейшим из возможных способов. Недопустимо
...
3. Автор задачи знакомится со списком замечаний и пожеланий, готовит список вопросов и обсуждает 
   их с ревьюером. В начале работы над исправлениями по замечаниям автор задачи меняет статус задачи
...
5. Если ревьювер с чем-то не согласен, он отмечает незавершённые пункты и отдаёт их на доработку,
   и процесс повторяется с шага 4.

#### 6.4.5. Противоречия и споры в процессе обзора кода
...
#### 6.4.6. Правила для участников, проверяющих код
...
#### 6.4.7. Состав участников обзора кода
...
#### 6.4.8. Написание комментариев в процессе обзора кода
...
#### 6.4.9. Отношение к комментариям в обзоре кода
