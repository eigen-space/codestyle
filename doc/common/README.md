...
### 8.3. Локализация предложений

a. Предложение должно быть оформлено на двух языках: русский и английский.

b. При подаче предложения допускается использовать только один из них (русский).
Когда предложение готово к влитию, нужно перевести его на второй язык.
