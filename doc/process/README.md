...
e. \[Не автоматизировано\] Если кто-то не проявил интереса к предложению, т.е. не участвовал в его
...
e. \[Не автоматизировано\] Если работа над предложением не ведётся в течение 3-х дней, предложение 
