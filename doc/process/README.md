...
e. \[Не автоматизировано\] Если кто-то не проявил интереса к предложению, т.е. 
не участвовал в его просмотре и обсуждении, это не должно мешать предложению 
быть принятым. Если никто не одобрил предложение в оговоренное время, оно 
считается принятым и должно быть влито в ветку `dev`.
...
e. \[Не автоматизировано\] Если работа над предложением не ведётся в течение 3-х дней, 
предложение автоматически закрывается.
