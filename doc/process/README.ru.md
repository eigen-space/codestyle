...
b. Любые обсуждения выносятся на:
1. Кофе-брейки
2. Обеды
3. Ужины
4. Время после ревью других участников (пункт 3.5): 45 минут

c. Исключением являются вопросы, блокирующие работу: например, когда коллега забыл 
поделиться доступом в npm-репозиторий

d. Технические вопросы и проблемы публикуются в канал `help-desk`. Любой решивший 
сделать перерыв, может помочь с решением проблемы. 
