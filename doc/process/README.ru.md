...
b. Процесс итерации можно представить списком таких этапов 
(мероприятий):
...
Мотивация следующего правила: \
Обеспечить среду для максимальной концентрации и продуктивности каждого члена 
команды. 

a. В течение рабочего дня члены команды могут работать с [выключенными уведомлениями в 
мессенджерах](https://get.slack.help/hc/en-us/articles/214908388-Pause-notifications-with-Do-Not-Disturb). 
Также рекомендуется не беспокоить их вживую. Удалённая работа исключением не является. 

b. Вопросы и обсуждения выносятся в:
* Cпециальные временные окна «свобода слова». На них должен быть выделен 1 ч в день.
В это время вы просматриваете почту, сообщения, задаёте друг другу вопросы и отвечаете на них.
* Время обзора решений задач. В это время обсуждаются возникшие вопросы и их решения. Если
остаётся время, то обсуждаются вопросы, не касающиеся напрямую обзора.

c. Исключением являются вопросы, блокирующие работу. Однако прежде, чем кого-то беспокоить, следует: 
* Подумать, действительно ли это блокирует работу?
* Подумать, что можно с этим сделать? Например, поменять порядок работы, сделав сейчас то, 
что возможно, и уточнив детали в окна «‎свободы слова».

Если же это нечто, что действительно требует экстренной реакции, следует 
использовать telegram, телефон или личное общение (если в офисе).
