...
a. Файл с классом должен содержать только один класс и его экспортировать. 
Исключением является экспорт интерфейсов, дополняющих описание класса.
...
b. Экспорт выполнять в той же строке, что и объявление типа.
...
d. Необходимо давать максимально говорящие, понятные имена.
...
e. Не использовать в качестве названий слова являющиеся служебными для языка, 
...
### 4.4. \[Не автоматизировано\] Поля логического типа
...
#### 4.5.1. \[Не автоматизировано\] Именование переменных под объекты заглушек
