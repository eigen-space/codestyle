...
d. \[Не автоматизировано. Частично автоматизировано eigenspace/conditions\] Не следует разбивать условия на отдельные без необходимости, когда можно записать их 
через `||` или `&&`.
