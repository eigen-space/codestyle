...
c. \[Не автоматизировано. Есть реализация с неполным покрытием в eigenspace/conditions\] 
...
g. \[Автоматизировано eigenspace/conditions\] По возможности избегать лишних ветвей `else`. Это уместно, когда одно из значений 
