...
* \[Автоматизировано: IDEA code reformat\] Закрывающая фигурная скобка должна быть на отдельной строке после тела управляющей 
  конструкции. 
...
#### 2.2.1. \[Автоматизировано: IDEA code format\] Величина отступа
...
#### 2.2.4. \[Автоматизировано: IDEA code format\] Конструкция switch-case
...
#### 2.3.1. \[Автоматизировано: IDEA code format\] В одной строке должно быть не более одного выражения
...
#### 2.4.2. \[Автоматизировано: IDEA code format\] Отступ при переносе части выражения
...
#### 2.4.6. \[Частично автоматизировано: IDEA code format\] Перенос массивов
