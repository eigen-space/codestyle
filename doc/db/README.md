...
Правила именования сущностей соответствуют [правилам именования классов](../scripts/README.md#421----).
...
[правилам именования полей классов](../scripts/README.md#425--naming-convention---).
...
Название ограничения состоит из следующих групп:
...
- поля сущности, на которую налагаются ограничения
- \[необязательное\] сущность, с которой связана первая сущность
- \[необязательное\] поля сущности, с которой связана первая сущность
...
```sql
    ...
    -- Внешний ключ
    "fkFinancialInfo[instrumentId]Instrument[id]"
```
